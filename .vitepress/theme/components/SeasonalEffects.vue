    ...
    @for $i from 1 through 80 {
      &:nth-child(#{$i}) {
        ...
        @if $type == "glow" {
          ...
          border-radius: 50%;
          animation: 
            summer-rise calc(#{random-range(22, 43, $i)}s / var(--intensity)) linear infinite,
        ...
        @if $type == "bird" {
          ...
          animation: 
            summer-fly calc(#{random-range(42, 85, $i)}s / var(--intensity)) linear infinite,
          ...
          &::before { top: -45%; left: 0; transform: rotate(-35deg); }
          &::after { top: -45%; right: 0; transform: rotate(35deg); }
        }
      }
    }
  }
    ...
    @for $i from 1 through 80 {
      &:nth-child(#{$i}) {
        ...
        @if $type == "flake" {
          ...
          border-radius: 50%;
          animation: 
            winter-fall calc(#{random-range(12, 32, $i)}s / var(--intensity)) linear infinite,
        ...
        @if $type == "flake-cluster" {
          ...
          &::before { width: 65%; height: 65%; top: 0; left: 20%; }
          &::after { width: 45%; height: 45%; bottom: 10%; right: 10%; }
        ...
        @if $type == "frost" {
          ...
          &::before { width: 1px; height: 60%; top: 20%; left: 50%; transform: translateX(-50%); }
          &::after { width: 60%; height: 1px; top: 50%; left: 20%; transform: translateY(-50%); }
...
@keyframes summer-ray {
  0% { transform: rotate(#{random-range(-45, 45)}) scaleX(0); opacity: 0; }
  20% { opacity: 0.5; }
  80% { opacity: 0.5; }
  100% { transform: rotate(#{random-range(-45, 45)}) scaleX(1); opacity: 0; }
}
